  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{
        ...
        <Stack.Screen name="InitSplashScreen" component={InitSplashScreen} options={{
          headerShown: false
        }}/>
        <Stack.Screen name="MenuPrincipal" component={MenuPrincipal} options={{
          headerShown: false
        }}/>
        <Stack.Screen name="FormRegistrarPaciente" component={FormRegistrarPaciente} options={{
...
<Stack.Screen name="FormRehabilitar" component={FormRehabilitar} options={{
          title: 'Rehabilitar',
          headerStyle: {
            backgroundColor: colors.AppColor,
          },
...
<Stack.Screen name="FormConsultorio" component={FormRehabilitar} options={{
          title: 'Consulta',
          headerStyle: {
            backgroundColor: colors.AppColor,
          },
...
<Stack.Screen name="PantallaRevisarCita" component={PantallaRevisarCita} options={{
